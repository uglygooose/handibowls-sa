  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-8 pb-24">
      <AdminPageHero
        ...
        speckle={{ seed: "messages-list-hero", density: "high", opacity: 0.06 }}
        splatter={[
          { preset: splatterPreset, variant: 2, size: "L", rotate: -14, opacity: 0.55 },
          { preset: splatterPreset, variant: 0, size: "M", rotate: 28, opacity: 0.4, bottom: -40, left: 128 },
        ]}
        meta={
