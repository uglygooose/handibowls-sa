...
Pending: Phase 13 / 13-5 (monitoring) → 13-6 (content) → 13-7 (launch infra) → 13-8 (pre-launch QA + 13-3 real-device perf gate). Open drift items tracked in [`DRIFT_LOG.md`](DRIFT_LOG.md).
